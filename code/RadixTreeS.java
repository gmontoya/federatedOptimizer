...
class RadixTreeS implements Serializable {
    ...
    public RadixTreeS(String s, int m, int bm, int fm) {
        max = m;
        sep = s;
        bmax = bm;
        fmax = fm;
    ...
    public int getOverlap(RadixTreeS rt) {
        int defaultOverlap = 0;
        ...
        if (root == null || rt == null || rt.root == null) {
            ...
            return (defaultOverlap + root.getOverlap("", rt.root, ""));
        }
    }
    ...
    public void addToDefault(HashSet<LeafRadix> ls) {
        ...
        RadixTreeS.smartLoading(defaultValues, ves, 0, ves.size()-1);
    }

    public static void smartLoading(QTree qt, Vector<Integer> es, int inf, int sup) {
...
*/
        public int getOverlap(String pref1, NodeRadix other, String pref2) {
            ...
            if (other instanceof LeafRadix) {
                ...
                if (ec !=null && r1.equals(r2)) {
                    o += RadixTreeS.getOverlap(ec, other); //Math.min(this.num, other.num);
    ...
    class LeafRadix extends NodeRadix implements Serializable {
        ...
        public String toString() {
            return radix+" "+num+" "+valuesStr.toString()+"\n";
        }
        protected String pprint(String i) {
            return i+radix+" "+num+" "+valuesStr.toString()+"\n";
        }
        ...
        public int getOverlap(String pref1, NodeRadix other, String pref2) {
            ...
            if (other instanceof LeafRadix || ec != null) { //((BranchRadix) other).hasEmptyChild()) {                
                if (r1.equals(r2)) { 
                    o += RadixTreeS.getOverlap(this, ec); //Math.min(this.num, other.num);
                }
        ...
        public void buildQTrees() {
            ...
            valuesStr.clear();
            Vector<Integer> ves = new Vector(vs);
            RadixTreeS.smartLoading(values, ves, 0, ves.size()-1);
            done = true;
        }
        public boolean equals(Object o) {
            ...
            boolean b = (done == l.done) && (done ? values.equals(l.values) : (valuesStr.equals(l.valuesStr)));
            b = b && radix.equals(l.radix);
            return b;
        }
    }

    public static RadixTreeS simpleLoadTree(String file, int m, int bm, int fm) throws Exception {
        RadixTreeS t = new RadixTreeS("/", m, bm, fm);
    ...
    public static RadixTreeS loadTree(String file, int m, int bm, int fm) throws Exception {
        RadixTreeS t = new RadixTreeS("/", m, bm, fm);
        BufferedReader br = new BufferedReader(new FileReader(file));
        String l = br.readLine();
    ...
    public static void main(String[] args) throws Exception {
        ...
        RadixTreeS t1 = simpleLoadTree(file, m, bmax, fmax);
        t1.ensureMax();
    ...
    public static void main0(String[] args) throws Exception {
        ...
        RadixTreeS t1 = loadTree(file, m, bmax, fmax);
        t1.ensureMax();
        System.out.println(t1);
        System.out.println(t1.getNumberOfLeaves());
        file = args[2];
        RadixTreeS t2 = loadTree(file, m, bmax, fmax);
        t2.ensureMax();
