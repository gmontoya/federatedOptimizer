...
class TransformerInverseJoinOrder extends TransformCopy {

    ExprList el;
//    Vector<Op> services = new Vector<Op>();
    boolean bushy;

    public TransformerInverseJoinOrder(ExprList el, boolean b) {
        this.el = el;
        this.bushy = b;
    }
...
*/
    ...
    public static void main(String[] args) {
        ...
        Transform t = new TransformerInverseJoinOrder(el,b);
