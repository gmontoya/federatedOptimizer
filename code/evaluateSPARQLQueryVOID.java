...
class evaluateSPARQLQueryVOID {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (newQuery != null) {
            evaluateSPARQLQuery.evaluate(newQuery.toString(), queryId, false, t2);
        } else {
            evaluateSPARQLQuery.evaluate(query.toString(), queryId, true, t2);
        }
