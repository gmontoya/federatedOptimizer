...
class obtainLightIndex {
    ...
    public static void main(String[] args) {
        ...
        HashMap<Integer, HashMap<String,HashSet<String>>> io = getObjectIndex(iio1);
    ...
    public static void writeObjectIndex(HashMap<Integer, HashMap<String,HashSet<String>>> index, String fileName) {
    ...
    public static void writeIndex(HashMap<Integer, HashSet<String>> index, String fileName) {
    ...
    public static HashMap<Integer, HashMap<String,HashSet<String>>> getObjectIndex (HashMap<String, HashMap<String, HashMap<Integer,Integer>>> iio) {
        HashMap<Integer, HashMap<String, HashSet<String>>> io = new HashMap<Integer, HashMap<String,HashSet<String>>>();
        for (String o : iio.keySet()) {
            ...
            for (String p : psCsCount.keySet()) {
                ...
                for (Integer cs : csCount.keySet()) {
                    HashMap<String,HashSet<String>> pos = io.get(cs);
                    if (pos == null) {
                        pos = new HashMap<String,HashSet<String>>();
                    } 
                    HashSet<String> os = pos.get(p);
                    if (os == null) {
