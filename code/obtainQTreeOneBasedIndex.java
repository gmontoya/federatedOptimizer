...
class obtainQTreeOneBasedIndex {
    ...
    public static void main(String[] args) {
        ...
        QTreeOne qt = new QTreeOne(bmax, fmax);
        //try {
        processSubjectIndex(iis, qt);
        processObjectIndex(iio, qt);
        //System.out.println("num leaves: "+rt.getNumberOfLeaves());
        //System.out.println("(bqtb) rt: "+rt);
        /*String p = "<http://bio2rdf.org/ns/bio2rdf#xRef>";
        Integer cs1 = -1001423639;
        Integer cs2 = -491008352;
        String str = "http://bio2rdf.org/chebi:27856";*/
        ...
        ////rt.buildQTrees();
        ////System.out.println("Number of leaves: "+rt.getNumberOfLeaves());
        /*String s = "http://bio2rdf.org";
        String value = "chebi:27856";
...
*/
    ...
    public static void writeIndex(QTreeOne index, String fileName) {
    ...
    public static void processSubjectIndex (HashMap<String, Integer> iis, QTreeOne qt) { //RadixTreeOne rt, int tmax, int bmax, int fmax) { //, int N) {
//        int k = 0;
...
*/
    ...
    public static void processObjectIndex (HashMap<String, HashMap<String, HashMap<Integer,Integer>>> iio, QTreeOne qt) { //, int tmax, int bmax, int fmax) { //, int N) {
        //int k = 0;
        //RadixTreeOne aux = new RadixTreeOne("/", tmax, bmax, fmax);
