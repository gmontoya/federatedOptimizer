...
for d in ${toDo}; do
    ...
    /usr/bin/time -f "%e %P %t %M" java generateStatistics ${dumpFolder}/${federation}Data/${d}/${f}${suffix}.n3 ${fedBenchDataPath}/statistics${d} > outputGenerateStatistics${d} 2> errorGenerateStatistics${d}
