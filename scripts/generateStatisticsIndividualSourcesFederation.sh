...
for i in `seq 1 ${number}`; do
    ...
    echo "java ${flag} changeCPS ${odysseyStatsPath}/statistics${d}_cps_reduced10000CS ${odysseyStatsPath}/statistics${d}_cps_reduced10000CS_"
    ...
    echo "/usr/bin/time -f "%e %P %t %M" java ${flag} obtainRadixOneBasedIndex ${odysseyStatsPath}/statistics${d}_iis_reduced10000CS ${odysseyStatsPath}/statistics${d}_iio_reduced10000CS ${odysseyStatsPath}/statistics${d}_rtree_100_10_reduced10000CS_1 100 10 -1 10"
